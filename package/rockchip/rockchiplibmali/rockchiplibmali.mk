...
#ROCKCHIPLIBMALI_VERSION = 4a67d5c579d3ce1ef96e5b2db00bd828aeeb23db
#ROCKCHIPLIBMALI_SITE = https://github.com/heiher/libmali-rk3399.git

ROCKCHIPLIBMALI_SITE_METHOD = git
ROCKCHIPLIBMALI_LICENSE = MIT
ROCKCHIPLIBMALI_LICENSE_FILES = LICENSE.md
# ROCKCHIPLIBMALI_INSTALL_STAGING = FALSE
ROCKCHIPLIBMALI_DEPENDENCIES = mesa3d

# ROCKCHIPLIBMALI_PROVIDES = libgles libegl libopencl


# ROCKCHIPLIBMALI_LDFLAGS = -L$(TARGET_DIR)/usr/lib
